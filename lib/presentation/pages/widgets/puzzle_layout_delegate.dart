...
import 'package:puzzle/presentation/pages/widgets/number_of_moves_and_tiles_left.dart';
import 'package:puzzle/presentation/pages/widgets/puzzle_button.dart';
import 'package:puzzle/presentation/pages/widgets/puzzle_layout.dart';
import 'package:puzzle/presentation/pages/widgets/puzzle_title.dart';
  ...
  Widget build(BuildContext context) {
    return TextButton(
        ...
        backgroundColor: MaterialStateProperty.resolveWith<Color?>(
          (states) {
            if (tile.value == state.lastTappedTile?.value) {
              return PuzzleColors.white2;
            } else if (states.contains(MaterialState.hovered)) {
              return PuzzleColors.black2;
            } else {
              return PuzzleColors.blue90;
            }
          },
        ),
      ),
      ...
      child: Text(
        tile.value.toString(),
        semanticsLabel:
            '${tile.value.toString()} ${tile.currentPosition.x.toString()} ${tile.currentPosition.y.toString()}',
      ),
    );
  }
}
